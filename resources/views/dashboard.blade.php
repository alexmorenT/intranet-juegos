        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <div class="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border dark:border-gray-700 text-center">
                    ...
                    <p class="text-xl font-black text-red-500">🔥 {{ $racha }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 group hover:shadow-2xl transition-all duration-300 text-center">
                    <div class="h-28 bg-red-600 flex items-center justify-center text-5xl group-hover:scale-110 transition-transform duration-300 shadow-inner">
                        💣
                    </div>
                    <div class="p-6">
                        <h3 class="font-bold text-xl mb-2 text-gray-800 dark:text-white uppercase tracking-tight">
                        ...
                        @else
                        <a href="{{ route('juegos.bombparty') }}" class="inline-block w-full py-3 bg-red-600 text-white font-bold rounded-xl hover:bg-red-800 transition transform active:scale-95 shadow-lg shadow-red-100 dark:shadow-none">
                            JUGAR
                        </a>
                        @endif
                    </div>
